...
public class CompiledCode implements StackContent, CompiledCodeArg {
    ...
    public static enum OpCode {
        HALT, REFER, CONSTANT, FUNCTIONAL, TEST, FRAME, ARGUMENT, APPLY, POP, RETURN, NEG, ADD, SUB, MULT, DIV, MOD, EQUAL, NOT_EQUAL, LESS_THAN, LESS_THAN_EQUAL, LANDS, LORS, LNOT
    }
